...
func NewCodef(code mcode.Code, format string, args ...interface{}) error {
	return &Error{
		stack: callers(),
		text:  fmt.Sprintf(format, args...),
		code:  code,
...
// The parameter `skip` specifies the stack callers skipped amount.
func NewCodeSkip(code mcode.Code, skip int, text ...string) error {
	errText := ""
	if len(text) > 0 {
		errText = text[0]
	}
...
// The parameter `skip` specifies the stack callers skipped amount.
func NewCodeSkipf(code mcode.Code, skip int, format string, args ...interface{}) error {
	return &Error{
		stack: callers(skip),
		text:  fmt.Sprintf(format, args...),
		code:  code,
...
// It returns nil if given err is nil.
func WrapCode(code mcode.Code, err error, text ...string) error {
	if err == nil {
		return nil
	}
	errText := ""
...
// It returns nil if given `err` is nil.
func WrapCodef(code mcode.Code, err error, format string, args ...interface{}) error {
	if err == nil {
		return nil
	}
	return &Error{
...
// It returns nil if given err is nil.
// The parameter `skip` specifies the stack callers skipped amount.
func WrapCodeSkip(code mcode.Code, skip int, err error, text ...string) error {
	if err == nil {
		return nil
	}
	errText := ""
...
// It returns nil if given err is nil.
// The parameter `skip` specifies the stack callers skipped amount.
func WrapCodeSkipf(code mcode.Code, skip int, err error, format string, args ...interface{}) error {
	if err == nil {
		return nil
	}
	return &Error{
