...
func RegisterUserRouter(party router.Party) {
	...
	party.Handle("POST", "/password/", wrapper.Handler(controller.UserController{}.UserPassword))
	party.Handle("POST", "/change_password/", wrapper.Handler(controller.UserController{}.ChangePassword))
}
